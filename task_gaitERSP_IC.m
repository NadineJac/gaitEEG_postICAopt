function task_gaitERSP_IC(sii, PATH, cfg, fieldName)
% perform spectral PCA à la Seeber
...
for si = sii % loop through all subjects
    ...
    if runScript
        ...
        [F_Rest, Noise_cov] = baselineF(EEG_stand, cfg.f_axis, cfg.FWHM, 'IC'); %chanxfreq
        ...
        [Gait_avg, ERSP, GPM, cycle_cnt, valid_cycle_cnt] = gait_ersp(EEG_block, F_Rest,...
            ...
            cfg.gait_event, cfg.gait_timeNextHs, cfg.gait_event_order, 'IC');
